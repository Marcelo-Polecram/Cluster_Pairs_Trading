...
class Trader:
    ...
    def apply_trading_strategy(self, pairs, train_val_split, strategy='fixed_beta', entry_multiplier=1, exit_multiplier=0,
                               test_mode=False):
        """
    ...
    def summarize_results(self, sharpe_results, cum_returns, performance, total_pairs, n_years):
        """
